...
class tx_sfjquery_otherjs {
	...
	public function effectFade() {
		$path = $this->effectCore().',';
		return $path.t3lib_extMgm::siteRelPath('sfjquery').'res/jquery.effects.fade.min.js';
	}
